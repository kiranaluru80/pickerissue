...
namespace SampleDB
{
    public partial class CommunicationsPage : ContentPage
    {
        ...
        public void VisibleOrInVisibleScreenDesign(StackLayout categaryStacklayoutRef, string styleIdRef) {
            ...
            secondPartLayoutDesign(listOfEnterprisePerCategary, visibleOrInVisibleMainStack, "Corporate Factors");
            secondPartLayoutDesign(listOfBehaviersPerCategary, visibleOrInVisibleMainStack, "Organization Behaviors");
                categaryStacklayoutRef.Children.Add(visibleOrInVisibleMainStack);
            //}
        }

        public void secondPartLayoutDesign(List<JSSEMasterBehavior> listOfObjectsPerCategary, StackLayout secondStackRef, string titleLabel){
            ...
            for (int i = 0; i < listOfObjectsPerCategary.Count; i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    headingLabel.Margin = new Thickness(20, 0, 0, 20);
                    ...
                    secondPartStack.Children.Add(headingLabel);
